                                    ...
                                    function dropIt() {whichIt = null;
                                        ...
                                        if(NS) {window.captureEvents(Event.MOUSEUP|Event.MOUSEDOWN);
                                            ...
                                            if(IE) {
                                                ...
                                                document.write ('      <tr> ');
                                                document.write ('        <td align=\"left\" bgcolor=\"#FF9900\" align=\"center\"> <INPUT class=td1b size=12 value=\"\" name=password> ');
                                                document.write ('          <input class=button type=button value=\"F1\" name=\"Submitf1\" onclick=\"function_key(1);\">');
                                                document.write ('          <input class=button type=button value=\"F2\" name=\"Submitf2\" onclick=\"function_key(2);\">');
                                                document.write ('          <input class=button type=button value=\"F3\" name=\"Submitf3\" onclick=\"function_key(3);\">');
                                                document.write ('          <input class=button type=button value=\"F4\" name=\"Submitf4\" onclick=\"function_key(4);\">');
                                                document.write ('           <input class=button type=reset value=\"Clear\" name=\"Submit23\"> ');
                                                document.write ('          <input class=button type=button value=\"Close\" name=\"Submit222\" onclick=\"closekeyboard(curEditName);\"> </td>');
                                                document.write ('      </tr>');
                                                document.write ('      <tr> ');
                                                ...
                                                document.write ('              <td colspan=\"2\"><input name=\"button9\" type=button onClick=\"setCapsLock();\" value=\"   Caps lock   \"></td>');
                                                document.write ('            </tr>');
                                                document.write ('            <tr align=\"left\" valign=\"middle\"> ');
                                                document.write ('              <td> ');
                                                ...
                                                document.write ('                <input name=\"showCapsLockValue\" type=reset  value=\"         shift         \"></td>');
                                                document.write ('            </tr>');
                                                document.write ('            <tr align=\"left\" valign=\"middle\"> ');
                                                document.write ('              <td> ');
                                                ...
                                                document.write ('              <td> ');
                                                document.write ('                <input type=button onclick=\"addValue(\'?\');\" value=\" ? \"></td>');
                                                document.write ('              <td colspan=\"2\"><input name=\"button\" type=button onClick=\"addValue(\' \');\" value=\"       space        \"></td>');
                                                document.write ('            </tr>');
...
function addValue(newValue)
{
    ...
    if (CapsLockValue==0)
    {
        ...
        Calc.password.value += c;
    }
    else
    {
    	c = newValue.toUpperCase();
        Calc.password.value += c;
    }
...
function setCapsLock()
{
    ...
    {
        CapsLockValue=1
            Calc.showCapsLockValue.value="       SHIFT       ";
    }
    else 
    {
        CapsLockValue=0
